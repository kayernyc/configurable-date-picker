...
const datePickerControl = new DatePickerControl(model, container, [{ dateType: 5, viewType: 1, grouped: true, looping: true, seedDate: new Date('December 17, 1995 03:24:00') }])
